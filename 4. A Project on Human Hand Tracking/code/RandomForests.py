...
param_grid = {
    'n_estimators': [150],                  # The number of trees in the forest, default=100
    'min_samples_split': [5],               # default=2
    'max_depth': [None],                    # default=None
    'max_features': ['sqrt']                # The number of features to consider when looking for the best split, default=None(max_features=n_features)
}
...
# %%
# # save
with open('result_AccRun_RF.pickle', 'wb') as f:
    pickle.dump(final_dict, f, pickle.HIGHEST_PROTOCOL)


# %%
# load
with open('result_AccRun_RF.pickle', 'rb') as f:
